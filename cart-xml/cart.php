 ...
 <link href="cart-xml/css/main.css" rel="stylesheet"/> <div id="cart-container">
	<div class="col-md-7">
		...
		if(file_exists("cart-xml/products.xml"))
		{
			$file="cart-xml/products.xml";
		}
		else
		{
		...
		<br/><br/>
		 <div class="panel panel-default cart-panel">
			<div class="panel-heading">
				<img class="pull-left add-right-margin" height="20" src="cart-xml/images/cart-m.png"/>
...
<div id="payment-container">
	...
	<form id="payment-from" action="cart-xml/process_order.php" target="ajax-ifr">
	...
	?>
		...
		<img src="cart-xml/images/paypal.png" alt="Payment through PayPal.com"/>
	<?php
	}
